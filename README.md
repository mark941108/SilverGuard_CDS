...
*Note: Wait ~10 minutes. The `KAGGLE_BOOTSTRAP.py` script will auto-install dependencies, compile `espeak-ng`, and launch the Demo. Review **Cell 5** (JSON analysis) and **Cell 7** (UI).*
