...
### 🧩 Scene 2 Asset: High-Contrast Architecture Diagram (For Video)
Use this Mermaid code in [Mermaid Live Editor](https://mermaid.live/) to generate the high-quality SVG/PNG for the video overlay.
...
| 1:25-1:35 | **[特效]** 顯示溫度計動畫 + **Zoom In on Log: "STRATEGY SHIFT: Lowering Temp (0.6 -> 0.2)"** 🌡️ | *"It reduces temperature to 0.2 for deterministic reasoning, and retries."* |
